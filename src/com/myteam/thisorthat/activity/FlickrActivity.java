...
public class FlickrActivity extends Activity {
	...
	public static String createURL(int methodId, String parameter) {
		...
		case FLICKR_PHOTOS_SEARCH_ID:
			...
			url = FLICKR_BASE_URL + method_type + APIKEY_SEARCH_STRING
					+ TAGS_STRING + parameter + FORMAT_STRING + "&per_page="
					+ NUMBER_OF_PHOTOS + "&media=photos";
			break;
	...
	public class getImagesTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			dialog = ProgressDialog.show(FlickrActivity.this, "",
					"Please wait...");
		}
	}
	...
	// helper method, to construct the url from the json object. You can define
	// the size of the image that you want, with the size parameter.
	// Be aware that not all images on flickr are available in all sizes.
	public static String constructFlickrImgUrl(JSONObject input, Enum size)
