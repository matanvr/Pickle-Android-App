...
public class RecipientsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mQuestionText = getIntent().getStringExtra(NewPost.QUESTION_TEXT);
	...
	protected ParseObject createMessage() {
		...
		message.put(ParseConstants.KEY_QUESTION_TEXT, mQuestionText);
		
		//byte[] fileBytes = FileHelper.getByteArrayFromFile(this, mMediaUri);
		try { 
			InputStream iStream =   getContentResolver().openInputStream(mMediaUri);
			byte[] fileBytes = FileHelper.getBytes(iStream);
			if (fileBytes == null) {
				return null;
			}
			else {
